...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.suns.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.suns.HelloProto.HelloRequest,
      com.suns.HelloProto.HelloRespnose> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.suns.HelloProto.HelloRequest.class,
      responseType = com.suns.HelloProto.HelloRespnose.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.suns.HelloProto.HelloRequest,
      com.suns.HelloProto.HelloRespnose> getHelloMethod() {
    io.grpc.MethodDescriptor<com.suns.HelloProto.HelloRequest, com.suns.HelloProto.HelloRespnose> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.suns.HelloProto.HelloRequest, com.suns.HelloProto.HelloRespnose>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.suns.HelloProto.HelloRespnose.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.suns.HelloProto.HelloRequest,
      com.suns.HelloProto.HelloRespnose> getHello1Method;
  ...
  public static io.grpc.MethodDescriptor<com.suns.HelloProto.HelloRequest,
      com.suns.HelloProto.HelloRespnose> getHello1Method() {
    io.grpc.MethodDescriptor<com.suns.HelloProto.HelloRequest, com.suns.HelloProto.HelloRespnose> getHello1Method;
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    public void hello(com.suns.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.suns.HelloProto.HelloRespnose> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getHelloMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<com.suns.HelloProto.HelloRequest> hello1(
        io.grpc.stub.StreamObserver<com.suns.HelloProto.HelloRespnose> responseObserver) {
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                com.suns.HelloProto.HelloRespnose>(
                  this, METHODID_HELLO)))
          .addMethod(
            getHello1Method(),
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.suns.HelloProto.HelloRespnose hello(com.suns.HelloProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.suns.HelloProto.HelloRespnose> hello(
